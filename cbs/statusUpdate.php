...
<br><br>
  ...
  <form method="POST" action="adminapprovalprocess.php">
      ...
      <?php
        ...
        echo '<select class="form-control" id="fstatus" style=" height:50px;width: 300px;"  name="fstatus">';
        while($rows=mysqli_fetch_array($results))
         { 
           ...
           else if($rows['s_id']==$rowb['b_status'])
           {
              echo"<option selected='selected' value='".$rows['s_id']."'>".$rows['s_desc']."</option>";
           }
           else
           {
